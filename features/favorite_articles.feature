Feature: FeedsLists
  ...
  I want to be able to add articles to FeedsLists
...
Scenario: Adding an article to a created FeedsList

  Given I am on the page of article named "Article1"
  And I have created the FeedsList "Favorites"
  When I safely select "Favorites" from "Add to FeedsList"
  Then I should safely see "'Article1' successfully added to Favorites."

Scenario: Adding an article to an uncreated FeedsList

  Given I am on the page of article named "Article2"
  When I safely selct "Create FeedsList" from "Add to FeedsList"
  Then I should be on the Create FeedsList page
...
Scenario: Renaming a FeedsList

  Given I am on the edit page for "Entertainment"
  When I fill in "Celebrities" for "Name"
  And I safely follow "Save Changes"
  Then I should see "Successfully updated FeedsList."
...
Scenario: Viewing an article from a FeedsList
...
Scenario: Viewing a friend's articles from a FeedsList
