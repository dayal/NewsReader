...
Scenario: go to article page
	...
	And I should see "As I watch today’s jump by Felix Baumgartner – it’s been running non-stop on most major news channels"
	When I follow "Watch Felix Baumgartner Live: This Scientific Discovery Brought To You By Mentos, The Freshmaker"
	Then I should be on the article's page
